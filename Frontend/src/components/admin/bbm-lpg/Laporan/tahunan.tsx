...
// Komponen utama untuk laporan tahunan
function TahunanComponent({ year, kuota_mt }: { year: string; kuota_mt: string }) {
...
// Wrapper component untuk route yang mengambil parameter dari URL
