...
export default function ReportBbm() {
  ...
  const downloadMonthlyExcel = async () => {
    try {
      ...
      link.setAttribute('download', `Laporan_BBM_${monthName}_${year}.xlsx`);
  ...
  const downloadYearlyExcel = async () => {
    try {
      ...
      const link = document.createElement('a');
      link.href = url;
      link.setAttribute('download', `Laporan_BBM_Tahunan_${yearlyForm.year}.xlsx`);
      document.body.appendChild(link);
      link.click();
      link.remove();
      window.URL.revokeObjectURL(url);
  ...
  return (
    <div className="mt-6 bg-white p-6 rounded-lg shadow-sm border">
      <div className="mb-6">
        <h2 className="text-xl font-bold text-gray-800">Report BBM</h2>
        <p className="text-sm text-gray-500">
          Generate dan ekspor laporan BBM berdasarkan bulan dan tahun.
        </p>
      </div>
      ...
      <div className="bg-blue-50 p-4 rounded-lg mb-6">
        ...
        <p className="text-sm text-gray-600 mb-4">
          Download laporan BBM bulanan dalam format Excel yang dikelompokkan berdasarkan SPBU dengan perhitungan realisasi liter.
        </p>
      ...
      <div className="bg-green-50 p-4 rounded-lg">
        ...
        <p className="text-sm text-gray-600 mb-4">
          Download laporan BBM tahunan dalam format Excel dengan breakdown per bulan untuk setiap SPBU dan jenis BBM.
        </p>
