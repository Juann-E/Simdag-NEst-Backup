-- Create Stock Pangan Tables
-- Database: simdag_main_db

USE simdag_main_db;

-- Create komoditas_stock_pangan table
...
-- Create transaksi_stock_pangan table
...
-- Pesan konfirmasi
SELECT 'Stock Pangan tables created and dummy data inserted successfully!' as message;